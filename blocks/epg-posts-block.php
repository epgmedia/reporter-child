...
class EPG_Posts_Block extends AQ_Block {

    //set and create block
    function __construct() {
        $block_options = array(
            'name' => __('Posts - By Tag','engine'),
            'size' => 'span12',
        );

        //create the block
        parent::__construct('epg_posts_block', $block_options);
    }
    ...
    function block($instance) {
        ...
        echo do_shortcode('[epg_posts title="'.$title.'" style="'.$style.'" category="'.$category.'" qty="'.$qty.'" orderby="'.$orderby.'" order="'.$asc.'" excerpt_length="'.$excerpt_length.'"]');
    }
